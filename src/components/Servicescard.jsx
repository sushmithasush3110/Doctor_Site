                            ...
                            <div className='row p-2'>
                                <div className="card p-0" style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-body p-3">
                                        <h5 className="card-title" style={{color:'rgb(62, 147, 193)'}}>Fracture Treatment</h5>
                        ...
                        <div className='col-md-3 p-2'>
                            <div className='row p-2'>
                                <div className="card p-0" style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-body p-3">
                                        <h5 className="card-title" style={{color:'rgb(62, 147, 193)'}}>Frozen Shoulder</h5>
                        ...
                        <div className='col-md-3 p-2'>
                            <div className='row p-2'>
                                <div className="card p-0" style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-body p-3">
                                        <h5 className="card-title" style={{color:'rgb(62, 147, 193)'}}>Shoulder Arthroscopy</h5>
                        ...
                        <div className='col-md-3 p-2'>
                            <div className='row p-2'>
                                <div className="card p-0" style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-body p-3">
                                        <h5 className="card-title" style={{color:'rgb(62, 147, 193)'}}>Knee arthroscopy</h5>
                    ...
                    <div className='row'>
                        ...
                        <div className='row p-2'>
                                <div className="card p-0" style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-body p-3">
                                        <h5 className="card-title" style={{color:'rgb(62, 147, 193)'}}>Rotator Cuff Injury Treatment</h5>
                        ...
                        <div className='row p-2'>
                                <div className="card p-0" style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-body p-3">
                                        <h5 className="card-title"style={{color:'rgb(62, 147, 193)'}}>Spinal Disc Surgery</h5>
                        ...
                        <div className='row p-2'>
                                <div className="card p-0" style={{ width: '18rem'}}>
                                    ...
                                    <div className="card-body p-3">
                                        <h5 className="card-title" style={{color:'rgb(62, 147, 193)'}}>Revision Hip & Knee Arthroplasty</h5>
                                        <p className="card-text" style={{ fontSize: '14px' }}>It is a longer, more complex procedure. It requires extensive planning, as well as the use of specialized implants and tools, in order to achieve a good result.</p>
